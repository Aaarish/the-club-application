...
public class RoomMemberController {
    ...
    @PostMapping
    public ResponseEntity<AppResponse> addMember(@PathVariable String clubId, @PathVariable String roomId, @RequestBody MemberRequest request, @AuthenticationPrincipal AuthUser user) throws ResourceNotFoundException, ActionDeniedException {
        return ResponseEntity.ok(memberFacadeService.addRoomMember(clubId, roomId, request.getUserIdForMember(), user.getAppUser().getUserId()));
    }
    ...
    public ResponseEntity<AppResponse> promoteMemberDegree(@PathVariable String roomId, String memberId, String memberDegree, @AuthenticationPrincipal AuthUser user) throws ResourceNotFoundException, ActionDeniedException {
    ...
    public ResponseEntity<AppResponse> demoteMemberDegree(@PathVariable String roomId, String memberId, String memberDegree, @AuthenticationPrincipal AuthUser user) throws ResourceNotFoundException, AccessDeniedException, ActionDeniedException {
    ...
    public ResponseEntity<DeleteResponse> removeRoomMember(String roomId, String memberId, @AuthenticationPrincipal AuthUser user) throws ResourceNotFoundException, ActionDeniedException {
